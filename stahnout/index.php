...
<a href="http://portableapps.com/apps/internet/firefox_portable" onclick="_gaq.push(['_trackEvent', 'Link', 'Firefox', this.href]);" hreflang="en">
stáhnout z domovské stránky</a> v anglické verzi. Pro lokalizaci je potřeba
<a href="http://portableapps.com/apps/internet/firefox_portable/localization" onclick="_gaq.push(['_trackEvent', 'Link', 'Firefox', this.href]);" hreflang="en">stáhnout
a nainstalovat jazykový balíček</a>. Detailnější postup si můžete
<a href="http://jasnapaka.bloguje.cz/515929-jak-pocestit-firefox-portable.php" onclick="_gaq.push(['_trackEvent', 'Link', 'Firefox', this.href]);">přečíst v českém návodu.</a></p>
...
<div class="side"><div class="side-in">
	...
	<dl>
		<dt><a href="https://addons.mozilla.org/cs/firefox/addon/1865" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);" lang="en">Adblock Plus</a></dt>
		<dd>Snadné blokování reklam ve stránkách.</dd>

		<dt><a href="https://addons.mozilla.org/cs/firefox/addon/398" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);" lang="en">ForecastFox</a></dt>
		<dd>Předpověď počasí přímo ve stavovém řádku.</dd>

		<dt><a href="https://addons.mozilla.org/cs/firefox/addon/12" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);" lang="en">All-in-One Gestures</a></dt>
		<dd>Ovládání prohlížeče pomocí gest myši.</dd>
	</dl>
	
	<p><strong><a href="https://addons.mozilla.org/cs/firefox/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">Další rozšíření...</a></strong></p>

	<h3>Motivy vzhledu</h3>
	
	<p>Ozdobte si Firefox pomocí vzhledů <a href="https://addons.mozilla.org/cs/firefox/personas/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">Personas</a>,
	  které dodají vašemu Firefoxu svěží vzhled.</p>
	  
  <p><a href="https://addons.mozilla.org/cs/firefox/addon/sunset-over-water/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">
		<img src="/img/personas3.jpg" alt="Náhled vzhledu Personas" /></a></p>	  
	  
  <p><a href="https://addons.mozilla.org/cs/firefox/addon/japanese-tattoo/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">
		<img src="/img/personas1.jpg" alt="Náhled vzhledu Personas" /></a></p>

  <p><a href="https://addons.mozilla.org/cs/firefox/addon/red-ladybug/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">
		<img src="/img/personas2.jpg" alt="Náhled vzhledu Personas" /></a></p>
		
	<p><strong><a href="https://addons.mozilla.org/cs/firefox/personas/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">Procházet galerii...</a></strong></p>
	
	<p>Chcete kompletní proměnu Firefoxu? Vyzkoušejte některý z 
		<a href="https://addons.mozilla.org/cs/firefox/themes/" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">motivů vzhledů</a>, který vás zaujme.
	</p>
	...
	<dl>
		...
		<dt><a href="http://www.slunecnice.cz/product/MozBackup/"
			 lang="en" onclick="_gaq.push(['_trackEvent', 'Link', 'Addon', this.href]);">MozBackup</a></dt>
